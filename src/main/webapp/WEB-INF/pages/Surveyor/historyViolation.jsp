            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <c:choose>
                          <c:when test="${violationHistoryList.size()>0}">
                              <table class="table table-striped">
                                  ...
                                  <c:forEach var="item" items="${violationHistoryList}" varStatus="status">
                                      <tr>
                                          ...
                                          <c:choose>
                                              <c:when test="${'未处理'.equals(item.violationState)}">
                                                  <td style="font-weight: bold;color: red">未处理</td>
                                              </c:when>
                                              <c:when test="${'处理中'.equals(item.violationState)}">
                                                  <td style="font-weight: bold;color: blue">处理中</td>
                                              </c:when>
                                              <c:when test="${'已处理'.equals(item.violationState)}">
                                                  <td style="font-weight: bold;color: green">已处理</td>
                                              </c:when>
                                          </c:choose>
                                      </tr>
                                  </c:forEach>
